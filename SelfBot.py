...
cl = LINETCR.LINE()
cl.login(token="EozhfywTbVeHM20e75l6.fTKCLmFlBfpEHyAxbVypLG.JN9bxNMRnzf66dRJy4a7CeVxEwbISIb+hw/1X8HO5R0=")
cl.loginResult()
    ...
    try:
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     ...
                     balas = ["Bejo lgi ngopi....kalau gaswaat pm aja"]
                     ret_ = "[Tag.Com] " + random.choice(balas)
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["kickMention"] == True:
                     contact = cl.getContact(msg.from_)
                     cName = contact.displayName
                     balas = ["Dont Tag Me!! Im Sibukk",cName + " Ngapain Ngetag?",cName + "","bejo.. lagi Ngopii", cName + "" + cName, "Jangan lupa Bahagia kak"]
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
                ...
                cl.sendText(msg.to, "「Speed In Progress」")
                start = time.time()
                time.sleep(0.07)
