...
#􀂳􀰂􀰂􀰂􀰂[數]KR-01☪ইद 􀂳􏿿
kt = LINETCR.LINE()
kt.login(token="EoiRT3y3tPGWVcdfdKe9.yx+t2VJzkRNdlPU2RlUb2q.hon/REN1P9/JEx1jCbCbYSeBFc7TbmYph4i3fdVU+KU=")
kt.loginResult()
#􀂳􀰂􀰂􀰂􀰂[數]KR-02☪ইद 􀂳􏿿
ks = LINETCR.LINE()
ks.login(token="EoRgZHJ2WPAQdsSf8Y7a.Dhdy2GKcCS4nNmLJCaNpcG.g0FvKOnHKyN84MQqIq2nL0mrrEkg9/0yf8N1Xxc0YsU=")
ks.loginResult()
#􀂳􀰂􀰂􀰂􀰂[數]KR-03☪ইद 􀂳􏿿
ki = LINETCR.LINE()
ki.login(token="EoxgyHrLEhGgkcgfT3f6.l1sUJRZN2Plp7X7G+jey9G.dvMe4Jtf+bTSfoY634qPm7SZzw3shCCc9MYldLy2htY=")
ki.loginResult()
#􀂳􀰂􀰂􀰂􀰂[數]KR-04☪ইद 􀂳􏿿
kk = LINETCR.LINE()
kk.login(token="Eo0nFKvmQ87fRwChVAL6.NXd37ScSBDLnUL5NT3eDfG.5oqkWdkQNv6ycF6Jn8TaQmPCOXbEUA621ASY4YxsPOo=")
kk.loginResult()
#􀂳􀰂􀰂􀰂􀰂[數]KR-05☪ইद 􀂳􏿿
kc = LINETCR.LINE()
kc.login(token="EoldErCohaL9SBgtJHI0.jvg1Tro60ccaX1JDl6HsCa.plQ4RG0NkTPgqptPIkbuMt3hPbUPTCAY2vBt1BbmXEs=")
kc.loginResult()

#􀂳􀰂􀰂􀰂􀰂[數]KR-KiCker☪ইद 􀂳􏿿
kl = LINETCR.LINE()
kl.login(token="EoBzQwypnjVpfLnb7am2.YKQ148h2BP5FIRLn7L3/4G.JxVv1XXRwtA+dGxbqpGh3x+QSul5X6UZUV+C5JZEfZ4=")
kl.loginResult()
