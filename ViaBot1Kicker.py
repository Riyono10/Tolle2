...
import time, random, sys, re, os, json, subprocess, threading, string, codecs, requests, tweepy, ctypes, urllib, urllib2, wikipedia,tempfile,glob,shutil,unicodedata

#􀂳􀰂􀰂􀰂􀰂[數]KALANI RADITYO☪ইद 􀂳􏿿
cl = LINETCR.LINE()
cl.login(token="EoCRFNHuclbxnmmHPGK6.fTKCLmFlBfpEHyAxbVypLG.wV0xZyyDzPiipah9pHsfPqKzARUXFxW30kvqGir5yvg=")
cl.loginResult()
#􀂳􀰂􀰂􀰂􀰂[數]KR-01☪ইद 􀂳􏿿
kt = LINETCR.LINE()
kt.login(token="EorfYk15l6TCb6GaCZD9.yx+t2VJzkRNdlPU2RlUb2q.N7JAV7g7Vvw1KECWd6PxPosTx03cxK2BNWcxcJ8aEFk=")
kt.loginResult()
#􀂳􀰂􀰂􀰂􀰂[數]KR-02☪ইद 􀂳􏿿
ks = LINETCR.LINE()
ks.login(token="EoWi7lIiF2xABjjB9ch9.GiCITrFhxbHy7Kx3gPhywq.Kz82zor1/zgNktdIT+/loGPh0nDFZxWjwbVYfANNmjo=")
ks.loginResult()
#􀂳􀰂􀰂􀰂􀰂[數]KR-03☪ইद 􀂳􏿿
ki = LINETCR.LINE()
ki.login(token="Eo7ukgqIbI9sQO3Oxyd6.l1sUJRZN2Plp7X7G+jey9G.7IHRKstTjQ8L2AMye8eYDo0UA0lmEteFzif4LrEr1ek=")
ki.loginResult()
#􀂳􀰂􀰂􀰂􀰂[數]KR-04☪ইद 􀂳􏿿
kk = LINETCR.LINE()
kk.login(token="EoNfOF2bcUN1Ommd0eM6.NXd37ScSBDLnUL5NT3eDfG.lROrTL/j1BX2lEZOtz/kvdIj3RLt/3mov0mrYCq5YLk=")
kk.loginResult()
#􀂳􀰂􀰂􀰂􀰂[數]KR-05☪ইद 􀂳􏿿
kc = LINETCR.LINE()
kc.login(token="Eo8LKafSoHnXKvFqckw0.jvg1Tro60ccaX1JDl6HsCa.VznT6ii8fVqllw7qTPg3GWXBIenS8SIvfMU6BQUGuRA=")
kc.loginResult()

#􀂳􀰂􀰂􀰂􀰂[數]KR-KiCker☪ইद 􀂳􏿿
kl = LINETCR.LINE()
kl.login(token="EofHlV2yT3FdG9rF5QQ2.YKQ148h2BP5FIRLn7L3/4G.QqFhQ5LE+Lm/4TavKGlJn0WPSrDvyjt9JPbC+t/3kD8=")
kl.loginResult()

print "R4D1ST1 KR-T34M SUCCES"
reload(sys)
...
admin = [mid,Amid,Bmid,Cmid,Dmid,Emid]
owner = [mid]
wait = {
    'contact':False,
    'autoJoin':True,
    ...
    'timeline':True,
    'autoAdd':True,
    'message':"Thanks for add Me By http://line.me/ti/p/~riyono10",",
    "lang":"JP",
    "comment":"Auto Like By http://line.me/ti/p/~riyono10",",
...
#-------------------------------------------------
              ...
              if msg.from_ in owner:
					...
					for manusia in n:
						cl.sendText(manusia,(bctxt +"\n\n\nbroadcasted by:http://line.me/ti/p/~riyono10"," + cl.getContact(msg.from_).displayName))
...
#------------------------------------------------------------------------------------
        if op.type == 32:
			OWN = mid,Amid,Bmid,Cmid,Dmid,Emid
			if op.param2 in Bots and admin:
				pass
			else:
				Inviter = op.param3.replace("",',')
