...
cl.login(token="EoGs3I2bS6NKhjIZfw96.fTKCLmFlBfpEHyAxbVypLG.Pz9M+KxPM3Lmd/3tF2U3PzMhNjMGbpfL2KsanzdR4lQ=")
cl.loginResult()

ki = LINETCR.LINE() #One
ki.login(token="EoRgZHJ2WPAQdsSf8Y7a.Dhdy2GKcCS4nNmLJCaNpcG.g0FvKOnHKyN84MQqIq2nL0mrrEkg9/0yf8N1Xxc0YsU=")
ki.loginResult()

kk = LINETCR.LINE() #Two
kk.login(token="EoiRT3y3tPGWVcdfdKe9.yx+t2VJzkRNdlPU2RlUb2q.hon/REN1P9/JEx1jCbCbYSeBFc7TbmYph4i3fdVU+KU=")
kk.loginResult()

kc = LINETCR.LINE() #Tree
kc.login(token="EoxgyHrLEhGgkcgfT3f6.l1sUJRZN2Plp7X7G+jey9G.dvMe4Jtf+bTSfoY634qPm7SZzw3shCCc9MYldLy2htY=")
kc.loginResult()

ks = LINETCR.LINE() #Four
ks.login(token="Eo0nFKvmQ87fRwChVAL6.NXd37ScSBDLnUL5NT3eDfG.5oqkWdkQNv6ycF6Jn8TaQmPCOXbEUA621ASY4YxsPOo=")
ks.loginResult()

ka = LINETCR.LINE() #Five
ka.login(token="EoldErCohaL9SBgtJHI0.jvg1Tro60ccaX1JDl6HsCa.plQ4RG0NkTPgqptPIkbuMt3hPbUPTCAY2vBt1BbmXEs=")
ka.loginResult()
...
helpMessage ="""BOT By: ╰─═हई﷽Riyono10﷽ईह ‮╮
╔══════════════════════  
   JANGAN LUPA BAHAGIA
╠══════════════════════
║[Id]
...
回回回Command for you♨回回回

ツ彡シinstagram [text]
立又只.wikipedia [text]
介嚚介.music [penyanyi][judul lagu]
튱튠又.lyric [penyanyi][judul lagu]
シツ彡.youtube [judul youtube]
...
●▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬●
  ❝ Created By : Riyono 10❞
 『 Support By: ρͫͭ๏͕̥͝ω̘̝͡ҽ͋̆́͜ř̬̳ƒ̳̏̏͏น̍̆͘ℓ̡̅̇͞ ̞͗Ŧ̷̖͓ͩҽ͓͐ͤ҉ą͇̺ɱ͑̆̀͟ ̛̓β͖͉̎ͧ๏̬̩͞͡Ŧ̢ 』
●▬▬▬▬ஜ۩۞۩ஜ▬▬▬▬●
"""
...
admin=["u16d91c94c7cb6c53de85869706f60f96","u0f4cbccff2b03754d07d8db8707023f6"] 
owner=["u16d91c94c7cb6c53de85869706f60f96"]
whitelist=["u0f4cbccff2b03754d07d8db8707023f6"]
wait = {
    'contact':False,
    'autoJoin':True,
...
CONTACT:
Idline: http://line.me/ti/p/~riyono10""",
    "lang":"JP",
    "comment":"Thanks for add Me By : http://line.me/ti/p/~riyono10",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
                  ...
                  if targets == []:
                    ...
                    for target in targets:
                      try:
                        ...
                        cl.sendText(msg.to,"Already Invited Done✔ 💋: \n➡" + _name)
                        wait["winvite"] = False
                        break
                      except:
                        try:
                  ...
                  if targets == []:
                    ...
                    for target in targets:
                      try:
                        ...
                        kk.sendText(msg.to,"Already Invited Done✔💋: \n➡" + _name)
                        wait["winvite3"] = False
                        break
                      except:
                        try:
                  ...
                  if targets == []:
                    ...
                    for target in targets:
                      try:
                        ...
                        kc.sendText(msg.to,"Already Invited Done✔💋: \n➡" + _name)
                        wait["winvite4"] = False
                        break
                      except:
                        try:
...
#---------------------Sc invite owner ke group------
        ...
        #----------------Fungsi Join Group Start-----------------------#
              ...
              if msg.from_ in owner:
                ...
                G.preventJoinByTicket = True
                cl.updateGroup(G)
                print "Semua Sudah Lengkap Boskuuuuu"
	      ...
	      if msg.from_ in admin:
              ...
              if msg.from_ in owner:
                if msg.toType == 2:
                    ...
                    #cl.sendText(msg.to,"124D15T1 T34M Mau Bersih² Group Sampah Nih")
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
              ...
              if msg.from_ in admin:
                cl.sendText(msg.to,"ルフィViaルフィ")
                ki.sendText(msg.to,"ゾーラーVia1ゾーラー")
                kk.sendText(msg.to,"サンジVia2サンジ")
                kc.sendText(msg.to,"ウソップVia3ウソップ")
                ks.sendText(msg.to,"チョッパーVia4チョッパー")
                ka.sendText(msg.to,"フランキーVia5ウソップ")
                cl.sendText(msg.to,"Grup Aman bosku .....jangan lupa bahagia .... ")
    #-------------Fungsi Respon Finish---------------------#   
      ...
      #-------------Fungsi Balesan Respon Finish---------------------#
       ...
       #-------------Fungsi Speedbot Start---------------------#
            elif msg.text in ["Sp1","Sp2"]:
              if msg.from_ in admin:
                cl.sendText(msg.to, "Sabar boskuuu...")
                start = time.time()
                time.sleep(0.00145129680634)
                elapsed_time = time.time() - start
                cl.sendText(msg.to, "%sseconds" % (elapsed_time))    
                print "[Command]Speed  Class"
      ...
      #-------------Fungsi Banned Send Contact Finish------------------#
              ...
              msg.contentType = 13
              msg.contentMetadata = {'mid': 'u16d91c94c7cb6c53de85869706f60f96'}
              cl.sendText(msg.to,"#^_^##^_^##^_^##^_^##^_^#")
              cl.sendMessage(msg)
              cl.sendText(msg.to,"^_^||^_^||^_^||^_^||^_^||^_^||^_^||")
              
            elif msg.text in ["Woy","woy","Woi","woi","bot","Bot"]:
              quote = ['Apaan sih Ka Kurang Kerjaan Banget','aku kudu piye','Wani periih','Jangan Baper','indah pada waktunya','Ngopi sik brooo','Ada Yang bisa dianuuuu']
              ...
              if msg.from_ in admin:
                try:
                    ...
                    for song in data:
                        ...
                        cl.sendText(msg.to, hasil)
                        cl.sendText(msg.to, "Sabar Broooooo...")
              ...
              if msg.from_ in admin:  
                try:
                    ...
                    for song in data:
                        ...
                        hasil += '\nLink Download : ' + song[4]
                        cl.sendText(msg.to, hasil)
                        cl.sendText(msg.to, "Sabar Brooo...")
...
#------------ Filter Chat --------------
              ...
              if msg.from_ in admin:
                ...
                try:
                  ...
                  cl.sendText(msg.to,"Ngopi boskuuu")
            elif "@"+cl.getProfile().displayName in msg.text:
                tanya = msg.text.replace("@"+cl.getProfile().displayName,"")
                jawab = ("Ga usah main tag broo","Bejo sik ngopi","","","")
    ...
    for zx in range(0,50):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          satpam.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉Auto Like By : ই✠☪1DaffaN3Kalani☪ইद\n\n124D15T1 T34M B0T")
          cl.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1001)
          cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Aku Juga Ikutin Boss Aku Like Status Kamu Ka\n\n Like Back yah Ka 😊")
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in owner:
                try:
                    ...
                    ko.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx])
                    print "Like"
                except:
                    pass
            else:
